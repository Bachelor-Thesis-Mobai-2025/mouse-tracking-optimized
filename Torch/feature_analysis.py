...
def main():
    ...
    data_dir = 'data_truncated'  # Replace with the path to your data directory
    output_dir = '../Images/Neural Network/Feature Importance'  # Changed output directory name as requested
